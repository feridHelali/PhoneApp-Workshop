                            ...
                            <table className="w-full">
                                <tbody>
                                    <tr className="transition duration-300 ease-in-out bg-white border-b hover:bg-gray-100">
                                        ...
                                        whitespace-nowrap">
                                            <button className='inline-flex items-center self-end p-3 
                                            px-3 py-2 m-4 text-sm font-medium text-center text-white
                                            bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 
                                            focus:outline-none focus:ring-blue-300 dark:bg-red-600 
